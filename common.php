...
function needUpdate()
{
    ...
    if (!($github_version = getcache('github_version'))) {
        $tmp = curl('GET', 'https://raw.githubusercontent.com/womade/OneManager-php/master/version');
...
<script>
    function changedrivetype(d) {
        ...
        $frame .= '<a href="https://github.com/womade/OneManager-php" target="_blank">Github</a>';
        if (!$canOneKeyUpate) {
            $frame .= '
...
<form name="updateform" action="" method="post">
    <input type="text" name="auth" size="6" placeholder="auth" value="womade">
...
<script>
    function querybranchs()
    {
        ...
        //xhr.setRequestHeader("User-Agent","womade/OneManager");
...
function render_list($path = '', $files = [])
{
    ...
    $authinfo = '
<!--
    OneManager: An index & manager of Onedrive auth by yuanzheng.
    Github: https://github.com/womade/OneManager-php
-->';
