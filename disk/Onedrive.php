...
class Onedrive {
    ...
    function __construct($tag) {
        $this->disktag = $tag;
        $this->redirect_uri = 'https://s.ssss.fun/Link/onedisk';
        if (getConfig('client_id', $tag) && getConfig('client_secret', $tag)) {
            ...
            $this->client_id = 'c7c65ed2-aacd-48af-b676-00d71b9684e9';
            $this->client_secret = 'momC828*pwsxSJAATM64_()';
        }
...
<div>
    <form id="form1" action="" method="post" onsubmit="return notnull(this);">
        ...
        <div>
            ...
            <div id="NT_custom" style="display:none;margin:0px 35px">
                ...
                <div id="NT_secret" style="display:none;margin:10px 35px">
                    ...
                    return_uri(Reply URL):<br>https://s.ssss.fun/Link/onedisk<br>
        ...
        <br>';
        if ($_SERVER['language']=='zh-cn') $html .= '你要理解 https://s.ssss.fun/Link/onedisk 是github上的静态网站，<br><font color="red">除非github真的挂掉</font>了，<br>不然，稍后你如果<font color="red">连不上</font>，请检查你的运营商或其它“你懂的”问题！<br>';
        $html .='
        <input type="submit" value="' . getconstStr('Submit') . '">
    </form>
</div>
